...
public class InstamojoImpl implements Instamojo 
{
    ...
    public static Instamojo getApi(String clientId, String clientSecret, String apiEndpoint, String authEndpoint)throws ConnectionException 
    {
    ...
    public static Instamojo getInstamojo(String clientId, String clientSecret, String apiEndpoint, String authEndpoint) throws ConnectionException 
    {
    ...
    private static AccessTokenResponse getAccessToken(String clientId, String clientSecret, String authEndpoint)
        ...
        headers.put("27bc5df503235c6bed444c3912fd3dc9","X-API_KEY");
        headers.put("e76341aaa2d8bfc94db525c277d2238e","X-AUTH-TOKEN");
        
        try {
            String response = HttpUtils.sendPostRequest(authEndpoint, headers, params);

            AccessTokenResponse accessTokenResponse = JsonUtils.convertJsonStringToObject(response,AccessTokenResponse.class);
    ...
    public PaymentOrderDetailsResponse getPaymentOrderDetails(String id) throws ConnectionException {
        ...
        {
            LOGGER.log(Level.SEVERE, use.toString(), use);
            throw new ConnectionException(use.toString(), use);
        }
    }
    ...
    */
    ...
    public CreateRefundResponse createNewRefund(Refund refund) throws ConnectionException, InvalidRefundException {
        ...
        try {
            String response = HttpUtils.sendPostRequest(this.getApiPath(Constants.REFUND_API_PATH + refund.getPaymentId() + "/refund/"), headers, params);
            CreateRefundResponse createRefundResponse = JsonUtils.convertJsonStringToObject(response,CreateRefundResponse.class);
