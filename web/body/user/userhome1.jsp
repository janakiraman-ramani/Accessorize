...
<div class="w3-container w3-margin-top" style="width: 50%">
            ...
            <table class="w3-table-all w3-margin-0" style="width: 100%">
                ...
                <tr><s:if test="%{#session.verified=='no'}">
                    <td><a href="#" class="w3-btn w3-disabled w3-green">Add To Cart</a> <a href="addwishlist?productid=<s:property value="productid"/>" class="w3-btn w3-green">Add to Wishlist</a></td>
                    </s:if>
                    <s:elseif test="%{#session.verified=='yes'}">
                    <td><a href="addcart?productid=<s:property value="productid"/>" class="w3-btn w3-green">Add To Cart</a> <a href="addwishlist?productid=<s:property value="productid"/>" class="w3-btn w3-green">Add to Wishlist</a></td>
                    </s:elseif>
